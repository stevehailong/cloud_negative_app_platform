...
import (
	...
	"my-cloud/internal/resource/router"
...
func main() {
	...
	// 初始化数据库连接 - 连接到 resource_db
	dsn := "root:root123456@tcp(mysql:3306)/resource_db?charset=utf8mb4&parseTime=True&loc=Local"
	...
	// 注册路由
	router.SetupRouter(r, resourceHandler)
	...
	log.Printf("Resource Service 启动在端口 %d", port)
