...
type AppDeployment struct {
	...
	EnvID             int64      `gorm:"column:env_id;not null" json:"env_id"`
	ClusterID         int64      `gorm:"column:cluster_id;not null" json:"cluster_id"`
	Namespace         string     `gorm:"column:namespace;size:255;not null" json:"namespace"`
	WorkloadName      string     `gorm:"column:workload_name;size:255;not null" json:"workload_name"`
